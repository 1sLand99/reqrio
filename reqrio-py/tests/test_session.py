...
ja4 = "t13d1516h2_002f,0035,009c,009d,1301,1302,1303,c013,c014,c02b,c02c,c02f,c030,cca8,cca9_0005,000a,000b,000d,0012,0017,001b,0023,002b,002d,0033,44cd,fe0d,ff01_0403,0804,0401,0503,0805,0501,0806,0601"
...
resp = session.get('https://www.baidu.com/',
                   params,
                   text="sdfsdfdsf宋代的点点滴滴的点点滴滴的点点滴滴的点点滴滴的地方的",
                   content_type="text/plain",
                   auto_redirect=False)
print(resp.statue_code())
# print(resp.location())
print(resp.get_header("server", ""))
print(resp.cookies())
# print(resp.text())
#
#
