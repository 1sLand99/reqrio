...
async fn main() {
    ...
    let mut req = AcReq::new().with_fingerprint(fingerprint).with_alpn(ALPN::Http11);
    ...
    req.set_url("https://ticket.sxhm.com/applet/bms/sale_order/orderReservation?jhsgvYT0=0.KnvuGlqWl666J54D9qqexb.VoUlkx_gInfT5jNp4CrHdXQgbU1ixuhU1IFELjH3tpYihe7ngnrPAt7ZgpFr3C9aZZ2hLWFDgBb61SiZD44deHcRSp65vG").await.unwrap();
    req.set_json(json::object! {"planId":"2010255636437147648"});
