use std::fs;
use reqrio::{json, set_logger, set_max_level, Fingerprint, LevelFilter, Logger, ReqExt, ScReq, Timeout, UrlExt, ALPN};
...
fn main() {
    ...
    let mut req = ScReq::new()
        ...
        .with_key_log("2.log")
        .with_fingerprint(Fingerprint::random(fs::read_to_string("TOKEN").unwrap_or("".to_string())))
        // .with_mtls(certs, key)
