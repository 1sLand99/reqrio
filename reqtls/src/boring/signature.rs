...
impl AlgorithmSigner {
    ...
    fn new_rsa(md_ctx: *mut EVP_MD_CTX, pkey_ctx: *mut EVP_PKEY_CTX, signature: SignatureAlgorithm) -> RlsResult<AlgorithmSigner> {
        ...
        Ok(AlgorithmSigner { md_ctx, signature })
    }

    fn new_ec(md_ctx: *mut EVP_MD_CTX, signature: SignatureAlgorithm) -> RlsResult<AlgorithmSigner> {
        Ok(AlgorithmSigner { md_ctx, signature })
    }
    ...
    fn new(md_ctx: *mut EVP_MD_CTX, pkey_ctx: *mut EVP_PKEY_CTX, signature: SignatureAlgorithm) -> RlsResult<AlgorithmSigner> {
        let res = match signature {
            ...
            SignatureAlgorithm::ECDSA_SECP256R1_SHA256 | SignatureAlgorithm::ECDSA_SECP384R1_SHA384 | SignatureAlgorithm::ECDSA_SECP521R1_SHA512 => AlgorithmSigner::new_ec(md_ctx, signature),
...
#[cfg(test)]
mod tests {
    use crate::boring::certificate::Certificate;
    ...
    fn test_sign() {
        ...
        let sign = AlgorithmSigner::new_sign(key.pkey(), SignatureAlgorithm::RSA_PSS_RSAE_SHA256).unwrap();
